...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # inject applica il blocco ad ogni elemento dell'array con una variabile che fa da "accumulatore"
    # e che viene passata ad ogni iterazione. È un modo per salvare in modo temporaneo il risultato dell'operazione
    # come ad esempio quando si vuole calcolare la somma dei valori di un array o in modo più fantasioso quando si sta ricercando il valore massimo 
